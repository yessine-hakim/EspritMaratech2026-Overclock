    ...
    return (
        <main className="container mx-auto px-4 py-4 md:py-8">
            ...
            <button
                ...
                className="lg:hidden flex items-center gap-2 mb-4 px-4 py-2 bg-white rounded-lg shadow-sm border border-gray-200 font-bold text-primary"
            >
                <FaFilter size={14} className="text-accent" /> {showFilters ? 'Hide Filters' : 'Show Filters'}
            </button>

            <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-6 md:gap-8">
                {/* Filters Sidebar */}
                <aside className={`${showFilters ? 'block' : 'hidden'} lg:block bg-white p-4 md:p-6 rounded-xl shadow-sm h-fit lg:sticky lg:top-24`} aria-label="Search Filters">
                    <div className="flex items-center justify-between mb-4 md:mb-6 pb-3 md:pb-4 border-b border-gray-light">
                        <h3 className="font-bold text-base md:text-lg text-primary flex items-center gap-2">
                            <FaFilter size={14} className="text-accent" aria-hidden="true" /> Filters
                        </h3>
                    </div>
